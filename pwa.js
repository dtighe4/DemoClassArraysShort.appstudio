...
const cacheName = 'DemoClassArraysShort-2021-09-13 16:18:15.911562'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'DemoClassArraysShort'.length) === 'DemoClassArraysShort') {
